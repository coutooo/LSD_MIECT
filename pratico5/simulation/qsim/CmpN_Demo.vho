...
-- Design Ports Information
-- equal	=>  Location: PIN_U4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- notEqual	=>  Location: PIN_R6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ltSigned	=>  Location: PIN_V4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ltUnsigned	=>  Location: PIN_AB1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[0]	=>  Location: PIN_T3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[1]	=>  Location: PIN_N8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[1]	=>  Location: PIN_V1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[0]	=>  Location: PIN_U2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[2]	=>  Location: PIN_T4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[3]	=>  Location: PIN_T7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[3]	=>  Location: PIN_R2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[2]	=>  Location: PIN_U3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[4]	=>  Location: PIN_R1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[5]	=>  Location: PIN_R3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[5]	=>  Location: PIN_R5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[4]	=>  Location: PIN_R4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[6]	=>  Location: PIN_V3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input0[7]	=>  Location: PIN_R7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[7]	=>  Location: PIN_U1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input1[6]	=>  Location: PIN_V2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Equal0~3_combout\ = (\input1[6]~input_o\ & (\input0[6]~input_o\ & (\input0[7]~input_o\ $ (!\input1[7]~input_o\)))) # (!\input1[6]~input_o\ & (!\input0[6]~input_o\ & (\input0[7]~input_o\ $ (!\input1[7]~input_o\))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (\input1[4]~input_o\ & (\input0[4]~input_o\ & (\input0[5]~input_o\ $ (!\input1[5]~input_o\)))) # (!\input1[4]~input_o\ & (!\input0[4]~input_o\ & (\input0[5]~input_o\ $ (!\input1[5]~input_o\))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\input1[1]~input_o\ & (\input0[1]~input_o\ & (\input1[0]~input_o\ $ (!\input0[0]~input_o\)))) # (!\input1[1]~input_o\ & (!\input0[1]~input_o\ & (\input1[0]~input_o\ $ (!\input0[0]~input_o\))))
...
-- Equation(s):
-- \LessThan0~11_cout\ = CARRY((\input1[5]~input_o\ & (\input0[5]~input_o\ & !\LessThan0~9_cout\)) # (!\input1[5]~input_o\ & ((\input0[5]~input_o\) # (!\LessThan0~9_cout\))))
...
-- Equation(s):
-- \LessThan0~13_cout\ = CARRY((\input1[6]~input_o\ & ((!\LessThan0~11_cout\) # (!\input0[6]~input_o\))) # (!\input1[6]~input_o\ & (!\input0[6]~input_o\ & !\LessThan0~11_cout\)))
...
-- Equation(s):
-- \LessThan0~14_combout\ = (\input1[7]~input_o\ & (\LessThan0~13_cout\ & \input0[7]~input_o\)) # (!\input1[7]~input_o\ & ((\LessThan0~13_cout\) # (\input0[7]~input_o\)))
...
-- Equation(s):
-- \LessThan1~1_cout\ = CARRY((\input1[0]~input_o\ & !\input0[0]~input_o\))
...
-- Equation(s):
-- \LessThan1~3_cout\ = CARRY((\input1[1]~input_o\ & (\input0[1]~input_o\ & !\LessThan1~1_cout\)) # (!\input1[1]~input_o\ & ((\input0[1]~input_o\) # (!\LessThan1~1_cout\))))
...
-- Equation(s):
-- \LessThan1~9_cout\ = CARRY((\input1[4]~input_o\ & ((!\LessThan1~7_cout\) # (!\input0[4]~input_o\))) # (!\input1[4]~input_o\ & (!\input0[4]~input_o\ & !\LessThan1~7_cout\)))
...
-- Equation(s):
-- \LessThan1~14_combout\ = (\input1[7]~input_o\ & ((\LessThan1~13_cout\) # (!\input0[7]~input_o\))) # (!\input1[7]~input_o\ & (\LessThan1~13_cout\ & !\input0[7]~input_o\))
