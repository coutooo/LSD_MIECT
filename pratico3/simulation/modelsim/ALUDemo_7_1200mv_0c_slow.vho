...
-- Design Ports Information
-- pin_name1	=>  Location: PIN_B3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst321|decOut_n~0_combout\ : std_logic;
SIGNAL \inst321|decOut_n~1_combout\ : std_logic;
SIGNAL \inst321|decOut_n~2_combout\ : std_logic;
SIGNAL \inst321|decOut_n~3_combout\ : std_logic;
SIGNAL \inst321|decOut_n~4_combout\ : std_logic;
SIGNAL \inst321|decOut_n~5_combout\ : std_logic;
SIGNAL \inst321|decOut_n~6_combout\ : std_logic;
...
SIGNAL \inst321|ALT_INV_decOut_n~2_combout\ : std_logic;
SIGNAL \inst321|ALT_INV_decOut_n~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\inst321|ALT_INV_decOut_n~2_combout\ <= NOT \inst321|decOut_n~2_combout\;
\inst321|ALT_INV_decOut_n~0_combout\ <= NOT \inst321|decOut_n~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst321|ALT_INV_decOut_n~0_combout\,
	devoe => ww_devoe,
	o => \HEX0[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst321|ALT_INV_decOut_n~2_combout\,
	devoe => ww_devoe,
	o => \HEX0[4]~output_o\);
...
-- Equation(s):
-- \inst|Add0~3_combout\ = (\inst|Add0~0_combout\ & ((\SW[4]~input_o\ & (\inst|Add0~2_cout\ & VCC)) # (!\SW[4]~input_o\ & (!\inst|Add0~2_cout\)))) # (!\inst|Add0~0_combout\ & ((\SW[4]~input_o\ & (!\inst|Add0~2_cout\)) # (!\SW[4]~input_o\ & 
-- ((\inst|Add0~2_cout\) # (GND)))))
-- \inst|Add0~4\ = CARRY((\inst|Add0~0_combout\ & (!\SW[4]~input_o\ & !\inst|Add0~2_cout\)) # (!\inst|Add0~0_combout\ & ((!\inst|Add0~2_cout\) # (!\SW[4]~input_o\))))
...
-- Equation(s):
-- \inst|Mux1~1_combout\ = (\inst|Mux1~0_combout\ & (((!\inst|Mux0~0_combout\)) # (!\inst|Mod0|auto_generated|divider|divider|selnose[5]~1_combout\))) # (!\inst|Mux1~0_combout\ & (((\inst|Mux0~0_combout\ & \inst|Mult0|auto_generated|op_3~4_combout\))))
...
-- Equation(s):
-- \inst|Mux2~3_combout\ = (\inst|Mux2~2_combout\ & ((\SW[9]~input_o\) # ((\inst|Mod0|auto_generated|divider|divider|StageOut[13]~6_combout\) # (\SW[8]~input_o\))))
...
PORT MAP (
	dataa => \SW[9]~input_o\,
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[13]~6_combout\,
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst|Mux0~0_combout\ & (((\inst|Mux0~1_combout\) # (\inst|Mult0|auto_generated|op_3~2_combout\)))) # (!\inst|Mux0~0_combout\ & (\inst|Add0~6_combout\ & (!\inst|Mux0~1_combout\)))
...
\inst321|decOut_n~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~0_combout\ = (\inst|Mux3~4_combout\ & ((\inst|Mux2~1_combout\) # (\inst|Mux1~1_combout\ $ (!\inst|Mux0~3_combout\)))) # (!\inst|Mux3~4_combout\ & ((\inst|Mux1~1_combout\ $ (\inst|Mux2~1_combout\)) # (!\inst|Mux0~3_combout\)))
...
PORT MAP (
	...
	combout => \inst321|decOut_n~0_combout\);

-- Location: LCCOMB_X114_Y66_N2
\inst321|decOut_n~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~1_combout\ = (\inst|Mux1~1_combout\ & (!\inst|Mux3~4_combout\ & (\inst|Mux0~3_combout\ $ (!\inst|Mux2~1_combout\)))) # (!\inst|Mux1~1_combout\ & (\inst|Mux0~3_combout\ & ((\inst|Mux2~1_combout\) # (!\inst|Mux3~4_combout\))))
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~1_combout\);

-- Location: LCCOMB_X114_Y66_N28
\inst321|decOut_n~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~2_combout\ = (\inst|Mux2~1_combout\ & (((\inst|Mux3~4_combout\) # (!\inst|Mux0~3_combout\)))) # (!\inst|Mux2~1_combout\ & ((\inst|Mux1~1_combout\ & (!\inst|Mux0~3_combout\)) # (!\inst|Mux1~1_combout\ & ((\inst|Mux3~4_combout\)))))
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~2_combout\);

-- Location: LCCOMB_X114_Y66_N22
\inst321|decOut_n~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~3_combout\ = (\inst|Mux2~1_combout\ & ((\inst|Mux1~1_combout\ & ((!\inst|Mux3~4_combout\))) # (!\inst|Mux1~1_combout\ & (!\inst|Mux0~3_combout\ & \inst|Mux3~4_combout\)))) # (!\inst|Mux2~1_combout\ & (\inst|Mux0~3_combout\ & 
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~3_combout\);

-- Location: LCCOMB_X114_Y66_N16
\inst321|decOut_n~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~4_combout\ = (\inst|Mux1~1_combout\ & (!\inst|Mux0~3_combout\ & ((\inst|Mux3~4_combout\) # (\inst|Mux2~1_combout\)))) # (!\inst|Mux1~1_combout\ & (\inst|Mux0~3_combout\ & (\inst|Mux3~4_combout\ & \inst|Mux2~1_combout\)))
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~4_combout\);

-- Location: LCCOMB_X114_Y66_N26
\inst321|decOut_n~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~5_combout\ = (\inst|Mux0~3_combout\ & (\inst|Mux1~1_combout\ & (\inst|Mux3~4_combout\ $ (!\inst|Mux2~1_combout\)))) # (!\inst|Mux0~3_combout\ & ((\inst|Mux3~4_combout\ & (\inst|Mux1~1_combout\)) # (!\inst|Mux3~4_combout\ & 
-- ((\inst|Mux2~1_combout\)))))
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~5_combout\);

-- Location: LCCOMB_X114_Y66_N12
\inst321|decOut_n~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst321|decOut_n~6_combout\ = (\inst|Mux1~1_combout\ & (!\inst|Mux2~1_combout\ & (\inst|Mux0~3_combout\ $ (!\inst|Mux3~4_combout\)))) # (!\inst|Mux1~1_combout\ & (!\inst|Mux3~4_combout\ & (\inst|Mux0~3_combout\ $ (\inst|Mux2~1_combout\))))
...
PORT MAP (
	...
	datac => \inst|Mux3~4_combout\,
	datad => \inst|Mux2~1_combout\,
	combout => \inst321|decOut_n~6_combout\);
...
-- Equation(s):
-- \inst|Mult0|auto_generated|op_1~10_combout\ = \inst|Mult0|auto_generated|le5a\(3) $ (\inst|Mult0|auto_generated|le4a\(5) $ (!\inst|Mult0|auto_generated|op_1~9\))
...
-- Equation(s):
-- \inst|m[3]~8_combout\ = (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & (\SW[9]~input_o\ & \inst|Mult0|auto_generated|op_3~14_combout\)))
...
-- Equation(s):
-- \inst|m[1]~10_combout\ = (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & (\SW[9]~input_o\ & \inst|Mult0|auto_generated|op_3~10_combout\)))
